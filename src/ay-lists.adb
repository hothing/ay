...
package body Ay.Lists is
   ...
   function  hasPred (Iterator : List_Iterator) return Boolean is
   begin
      return (Iterator.List /= null and then Iterator.Current /= Iterator.List.First);
   end hasPred;

   function  hasSucc  (Iterator : List_Iterator) return Boolean is
   begin
      return (Iterator.List /= null and then Iterator.Current /= null);
   end hasSucc;
   ...
   procedure Rewind (Iterator : in out List_Iterator) is
   begin
