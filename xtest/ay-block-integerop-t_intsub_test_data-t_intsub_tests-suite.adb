...
package body Ay.Block.IntegerOp.T_IntSub_Test_Data.T_IntSub_Tests.Suite is

   package Runner_1 is new AUnit.Test_Caller
     (GNATtest_Generated.GNATtest_Standard.Ay.Block.IntegerOp.T_IntSub_Test_Data.T_IntSub_Tests.Test_T_IntSub);
   ...
   begin
      ...
      Runner_1.Create
        (Case_1_1_Test_doCalc_a00920,
         "ay-block-integerop.ads:24:4:",
         Test_doCalc_a00920'Access);
      Runner_1.Create
        (Case_1i_1_Test_doInit_9a6f7e,
         "ay-block-integerop.ads:16:4: inherited at ay-block-integerop.ads:42:4:",
         Test_doInit_9a6f7e'Access);
      Runner_1.Create
        (Case_2i_1_Test_doFinal_513a94,
         "ay-block.ads:32:4: inherited at ay-block-integerop.ads:42:4:",
...
end Ay.Block.IntegerOp.T_IntSub_Test_Data.T_IntSub_Tests.Suite;
--  end read only
