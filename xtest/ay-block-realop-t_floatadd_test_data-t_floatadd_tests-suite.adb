...
package body Ay.Block.RealOp.T_FloatAdd_Test_Data.T_FloatAdd_Tests.Suite is

   package Runner_1 is new AUnit.Test_Caller
     (GNATtest_Generated.GNATtest_Standard.Ay.Block.RealOp.T_FloatAdd_Test_Data.T_FloatAdd_Tests.Test_T_FloatAdd);
...
end Ay.Block.RealOp.T_FloatAdd_Test_Data.T_FloatAdd_Tests.Suite;
--  end read only
