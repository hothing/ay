...
package body Ay.Block.RealOp.T_FloatGlobal_Test_Data.T_FloatGlobal_Tests.Suite is

   package Runner_1 is new AUnit.Test_Caller
     (GNATtest_Generated.GNATtest_Standard.Ay.Block.RealOp.T_FloatGlobal_Test_Data.T_FloatGlobal_Tests.Test_T_FloatGlobal);
...
end Ay.Block.RealOp.T_FloatGlobal_Test_Data.T_FloatGlobal_Tests.Suite;
--  end read only
