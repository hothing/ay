...
package body Ay.Block.IntegerOp.T_IntAdd_Test_Data.T_IntAdd_Tests.Suite is

   package Runner_1 is new AUnit.Test_Caller
     (GNATtest_Generated.GNATtest_Standard.Ay.Block.IntegerOp.T_IntAdd_Test_Data.T_IntAdd_Tests.Test_T_IntAdd);
   ...
   begin
      ...
      Runner_1.Create
        (Case_1_1_Test_doInit_9a6f7e,
         "ay-block-integerop.ads:16:4:",
         Test_doInit_9a6f7e'Access);
      Runner_1.Create
        (Case_2_1_Test_doCalc_a00920,
         "ay-block-integerop.ads:19:4:",
         Test_doCalc_a00920'Access);
      Runner_1.Create
        (Case_1i_1_Test_doFinal_513a94,
         "ay-block.ads:32:4: inherited at ay-block-integerop.ads:40:4:",
...
end Ay.Block.IntegerOp.T_IntAdd_Test_Data.T_IntAdd_Tests.Suite;
--  end read only
